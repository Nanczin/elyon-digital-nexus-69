...
/**
 * Safely casts a Json type to a specific object type after runtime checks.
 * Returns null if the Json value is not a non-null, non-array object.
 *
 * @param json The Json value to cast.
 * @returns The casted object or null.
 */
export function safeJsonCast<T extends object>(json: Json | null | undefined): T | null {
