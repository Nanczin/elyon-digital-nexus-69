  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="container mx-auto p-6 flex-1">
        ...
        <ProjectNavigationTabs projectId={projectId!} activeTab="analytics" />
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Analytics do Projeto: {project.name}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Esta é a página para visualizar os analytics do projeto com ID: <span className="font-semibold">{projectId}</span>.
              </p>
              <p className="mt-4">
                Funcionalidade em desenvolvimento. Aqui você poderá monitorar métricas de uso e engajamento.
              </p>
            </CardContent>
          </Card>
        </div>
